export function FounderCertificateActions({
  ...
  return (
    <div className="grid gap-3">
      ...
      <button onClick={onCopyVerification} className="rounded-2xl border border-slate-200 px-4 py-3 text-sm font-extrabold text-slate-700">Copier le lien de vérification</button>
    </div>
  );
}
