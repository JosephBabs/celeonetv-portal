...
const phraseTranslations: Partial<Record<TranslationLanguage, Partial<Record<TranslationLanguage, Record<string, string>>>>> = {
  en: {
    fr: {
      ...
      "au cours d une ceremonie solennelle à cotonou": "during a solemn ceremony in Cotonou",
      "le samedi 26 avril 2025 les quinze membres du conseil superieur de transition de l eglise du christianisme celeste ont ete officiellement installes au cours d une ceremonie solennelle à cotonou": "on Saturday, April 26, 2025, the fifteen members of the Celestial Church of Christ High Council of Transition were officially installed during a solemn ceremony in Cotonou",
  ...
  es: {
    fr: {
      ...
      "au cours d une ceremonie solennelle à cotonou": "durante una ceremonia solemne en Cotonou",
      "le samedi 26 avril 2025 les quinze membres du conseil superieur de transition de l eglise du christianisme celeste ont ete officiellement installes au cours d une ceremonie solennelle à cotonou": "el sabado 26 de abril de 2025, los quince miembros del Consejo Superior de Transicion de la Iglesia del Cristianismo Celestial fueron instalados oficialmente durante una ceremonia solemne en Cotonou",
