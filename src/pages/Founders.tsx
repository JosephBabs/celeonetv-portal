        ...
        <div className="relative grid items-center gap-8 lg:grid-cols-[1.08fr_0.92fr]">
          <div className="max-w-3xl">
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              ...
              {/* <Link to="/founders/activate" className="inline-flex min-h-[54px] items-center justify-center rounded-full bg-white px-7 text-[15px] font-bold text-dark">
                Activer mon pass
              </Link> */}
              <Link to="/founders/activate" className="inline-flex min-h-[54px] items-center justify-center rounded-full border border-white/20 bg-white/10 px-7 text-[15px] font-bold text-white">
                Activer mon pass
              </Link>
