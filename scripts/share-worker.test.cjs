...
(async () => {
  ...
  const post = {id: 'reel-one', title: 'A reel', content: 'Public caption', videoUrl: 'https://media.example/video.mp4', thumbnailUrl: 'https://media.example/poster.jpg', videoShareImage: 'https://media.example/play-share.jpg', createdAtMs: 1700000000000};
  ...
  for (const expected of ['og:title', 'A reel', 'poster.jpg', 'VideoObject', 'og:video', 'video.other', 'play-share.jpg', 'celeone-post-data', 'https://celeonetv.com/reels/reel-one']) assert.ok(html.includes(expected), expected);
